...
void Initialize() {
    ...
    state.player.acceleration = glm::vec3(0, -9.8, 0);
    state.player.textureID = LoadTexture("cowboy.png");
    
    GLuint tileTextureID = LoadTexture("ground.png");
    
    state.platforms[0].textureID = tileTextureID;
    state.platforms[0].position = glm::vec3(-1.0, -3.25f, 0);
    
    state.platforms[1].textureID = tileTextureID;
    state.platforms[1].position = glm::vec3(0.0f,  -3.25f, 0);
    
    state.platforms[2].textureID = tileTextureID;
    state.platforms[2].position = glm::vec3(1.0f,  -3.25f, 0);
    
    state.platforms[3].textureID = tileTextureID;
    state.platforms[3].position = glm::vec3(3.0f,  -3.25f, 0);
